...
// <<---------------------------------------------------------------------------//CFG-MSG packets:
	// <<---------------------------------------------------------------------------//off packets
	uint8_t turn_Off_GPGGA[NMEA_LEN] = {//---------------------------------------------//GPGGA off
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_Off_GPGLL[NMEA_LEN] = {//---------------------------------------------//GPGLL off
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_Off_GPGSA[NMEA_LEN] = {//---------------------------------------------//GPGSA off
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_Off_GPGLV[NMEA_LEN] = {//---------------------------------------------//GPGSV off
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_Off_GPRMC[NMEA_LEN] = {//---------------------------------------------//GPRMC off
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_Off_GPVTG[NMEA_LEN] = {//---------------------------------------------//GPVTG off
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	// <<---------------------------------------------------------------------------//on packets
	uint8_t turn_On_GPGGA[NMEA_LEN] = {//---------------------------------------------//GPGGA on
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_On_GPGLL[NMEA_LEN] = {//---------------------------------------------//GPGLL on
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_On_GPGSA[NMEA_LEN] = {//---------------------------------------------//GPGSA on
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_On_GPGLV[NMEA_LEN] = {//---------------------------------------------//GPGSV on
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_On_GPRMC[NMEA_LEN] = {//---------------------------------------------//GPRMC on
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
	...
	uint8_t turn_On_GPVTG[NMEA_LEN] = {//---------------------------------------------//GPVTG on
	  0xB5, // Header char 1
	  0x62, // Header char 2
	  0x06, // class
	  0x01, // id
